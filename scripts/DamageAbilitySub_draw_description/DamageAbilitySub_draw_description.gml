...
draw_text(left + 104 + 8, top + 40 + LINE_HEIGHT*1, string(sub[@ DamageAbilitySub.Accuracy]));
draw_text(left + 104 + 8, top + 40 + LINE_HEIGHT*2, concat("+", (sub[@ DamageAbilitySub.DamageModifier] - 1) * 100, "%"));
draw_text(left + 104 + 8, top + 40 + LINE_HEIGHT*3, concat("+", sub[@ DamageAbilitySub.CriticalModifier], "%"));

return 40 + LINE_HEIGHT*4;
